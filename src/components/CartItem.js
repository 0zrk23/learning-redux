...
import { INCREASE, REMOVE, TOGGLE_AMOUNT } from "../actions";
import { DECREASE, removeItem } from './../actions';
  ...
  return (
    <div className="cart-item">
      ...
      <div>
        ...
        {/* decrease amount */}
        <button className="amount-btn" onClick={() => amount !== 1 ? toggle('dec') : remove()}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
...
export default connect(null,mapDispatch2Props)(CartItem);
